...
<Columns cols={2}>
  <Card title="Product page" icon="window" href="/docs/upsells/product-page">
    Display upsells on product detail pages.
  </Card>
  <Card title="Cart" icon="cart-shopping" href="/docs/upsells/cart">
    Show upsells in the sidebar cart or cart page.
  </Card>
  <Card title="Checkout" icon="credit-card" href="/docs/upsells/checkout">
    Add upsells during checkout (Shopify Plus only).
  </Card>
  <Card title="Post-purchase" icon="receipt" href="/docs/upsells/post-purchase">
    One-click upsells after checkout.
  </Card>
  <Card title="Order tracking" icon="truck" href="/docs/tracking/recommendations">
