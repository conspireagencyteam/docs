...
<Columns cols={2}>
  <Card title="Rewards programs" icon="coins" href="/docs/loyalty/rewards">
    Create automated store credit reward programs.
  </Card>
  <Card title="Referral program" icon="share-nodes" href="/docs/loyalty/referrals">
    Set up customer referrals with rewards.
  </Card>
  <Card title="Widgets" icon="window" href="/docs/loyalty/widgets">
