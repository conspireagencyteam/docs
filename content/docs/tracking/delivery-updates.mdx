...
<Steps>
  <Step title="Verify a sending domain">
    Go to **Emails > Settings** and [verify your sending domain](/docs/emails/domain-setup). If you've already set this up for subscription emails, you're done — the same domain is used for delivery update emails.
  </Step>
