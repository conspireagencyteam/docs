...
<Columns cols={2}>
  <Card title="Page builder" icon="paintbrush" href="/docs/tracking/page-builder">
    Create and customize your tracking page layout.
  </Card>
  <Card title="Links in Shopify" icon="envelope" href="/docs/tracking/shopify-links">
    Add a "Track your order" button to your Shopify emails and customer accounts.
  </Card>
  <Card title="Product recommendations" icon="bag-shopping" href="/docs/tracking/recommendations">
    Set up upsell offers on your tracking page.
  </Card>
  <Card title="Discount codes" icon="tag" href="/docs/tracking/discounts">
    Offer time-limited discounts to drive repeat purchases.
  </Card>
  <Card title="Analytics" icon="chart-line" href="/docs/tracking/analytics">
